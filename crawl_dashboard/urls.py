...
urlpatterns = [
    ...
    url(r'^crawlers/(?P<host>[\w\d\.\-]+)/(?P<crawl_date>[0-9\-]+)/$', crawl_views.view_summary, name='crawl_summary'),
    url(r'^crawlers/(?P<host>[\w\d\.\-]+)/(?P<crawl_date>[0-9\-]+)/(?P<domain>.+)/$', crawl_views.view_inventory, name='crawl_inventory'),
